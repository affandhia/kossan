...
interface InvoiceData extends typeof defaultData {
}
...
const Invoice = ({ data = defaultData }) => {
  const { landlord, tenant, invoice, property, payment, otherCharges, paymentTerms, comments } = data;
  return (
    <Box>
      <Typography variant="h4" component="div">Room Rent Invoice</Typography>
      <Typography variant="h5" component="div">Landlord's Information:</Typography>
      ...
      <Typography variant="h5" component="div">Tenant's Information:</Typography>
      <Typography>Name: {tenant.name}</Typography>
      <Typography>Contact Details: {tenant.contactDetails}</Typography>

      <Typography variant="h5" component="div">Invoice Information:</Typography>
      <Typography>Date: {invoice.date}</Typography>
      <Typography variant="h5" component="div">Property and Rent Information:</Typography>
      ...
      <Typography variant="h5" component="div">Payment Information:</Typography>
      <Typography>Accepted Payment Methods: {payment.acceptedMethods.join(', ')}</Typography>

      <Typography variant="h5" component="div">Other Charges:</Typography>
      <Typography>Taxes: {otherCharges.taxes}</Typography>

      <Typography variant="h5" component="div">Payment Terms:</Typography>
      <Typography>Late Payment Penalty: {paymentTerms.latePaymentPenalty} after {paymentTerms.latePaymentDate}</Typography>

      <Typography variant="h5" component="div">Comments or Notes:</Typography>
